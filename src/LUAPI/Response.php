...
class Response{
    ...
    /**
     * sets the whole response object. previous changes will be overwritten.
    ...
    /**
     * adds a key "error" to the response object with the given value.
    ...
    /**
     * sets the response code. use one of the HTTP_ constants.
    ...
    /**
     * sets a response header to "$name: $value"
    ...
    /**
     * sends the response object as json.

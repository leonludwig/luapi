...
class UserCreateWithArrayHandler extends Handler
{
...
case 'POST':
				...
				$this->createUsersWithArrayInput($request);
				return;
	...
	public function createUsersWithArrayInput(Request $request):mixed
	{
			
		//<luapi-gen id="validation-createUsersWithArrayInput">
		$validator = new createUsersWithArrayInputOAS3Validator($request);
...
class createUsersWithArrayInputOAS3Validator extends OAS3Validator
{
